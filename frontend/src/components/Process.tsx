...
export function Process() {
  return (
    <section
      id="how"
      className="bg-portway-primary scroll-mt-10 py-20 text-white md:py-24"
    >
      <div
        className="page-wrap grid gap-10 lg:grid-cols-2 lg:gap-14"
        data-reveal
      >
        <div className="flex min-h-0 flex-col">
          ...
          <p className="mt-4 text-base leading-7 text-white/60">
            Один менеджер координує весь процес — від першої консультації з
            клієнтом та протягом усього маршруту вантажу.
          </p>
