export function Footer() {
  return (
    <footer className="page-wrap footer-shell overflow-hidden bg-cleargatecustoms-primary text-white">
      <div className="px-6 pt-16 sm:px-10 sm:pt-20">
        <div className="grid gap-14 pb-10 lg:grid-cols-[1.35fr_0.65fr] lg:gap-20">
          <div className="footer-brand-lockup flex min-w-0 flex-col justify-between gap-16">
            <h2 className="from-cleargatecustoms-mint-muted to-cleargatecustoms-mint-soft w-full bg-linear-to-r via-[#b8cbc4] bg-clip-text text-2xl leading-[1.35] font-semibold tracking-tight text-balance text-transparent opacity-60">
      ...
      <div className="footer-brand-word text-cleargatecustoms-primary-hover/20 leading-[0.82] font-extrabold tracking-[-0.055em] whitespace-nowrap select-none">
        ClearGateCustoms
      </div>
