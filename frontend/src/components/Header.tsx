...
export function Header({ onContact }: Props) {
  ...
  return (
    <header className="liquid-header relative z-30 mt-5 flex h-16 items-center justify-between gap-6 rounded-full px-4 md:mt-6 md:px-5">
      <a
        href="#top"
      ...
      <div className="flex items-center gap-3">
        <Button onClick={onContact} size="compact" className="hidden md:inline-flex">
          Зв'язатися
        </Button>
        <button
          type="button"
