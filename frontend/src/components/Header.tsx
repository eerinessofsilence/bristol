...
export function Header({ onContact }: Props) {
  ...
  return (
    <header className="liquid-header fixed top-5 right-3 left-3 z-50 mx-auto flex h-16 max-w-[1160px] items-center justify-between gap-6 rounded-full px-4 md:top-6 md:right-6 md:left-6 md:px-8">
      <a
        href="#top"
      ...
      <div className="flex items-center gap-3">
        ...
        >
          <MessageCircle size={16} strokeWidth={2.4} fill="currentColor" />
          Зв'язатися
        </Button>
        <button
          type="button"
