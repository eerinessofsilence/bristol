...
export const faqs = [
  {
    ...
    answer:
      'Митне оформлення вантажу «Митні системи» виконує самостійно — наші фахівці готують декларацію, визначають код УКТ ЗЕД і супроводжують випуск. Додатково ми виступаємо посередником і координатором супутньої логістики: узгоджуємо роботу експедиторів, лінійних агентів, портових служб і перевізника, щоб вантаж дістався вашого складу без затримок.',
  },
  {
...
export const testimonials = [
  {
    ...
    quote:
      'Ще до прибуття контейнера ми знали план дій, строки й повну послідовність оформлення. Митні системи координували всіх учасників, а ми отримували статуси без нагадувань.',
    author: 'Олена К.',
    role: 'Імпортерка',
  ...
  },
  {
    ...
    quote:
      'Найцінніше — Митні системи одразу говорять, де є ризик і що потрібно виправити. Рішення приймаємо до прибуття вантажу, а не коли контейнер уже стоїть у порту.',
    author: 'Дмитро Л.',
